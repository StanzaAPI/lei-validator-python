...
class LeiValidatorClient:
    """Official zero-dependency client for Global LEI & Corporate Tax ID Validator API."""
    ...
    def __init__(
        ...
        self.tier = tier
        self.tool_url = "https://stanzaapi.com/tools/lei-validator"
    ...
    def _request(self, endpoint: str, method: str = "GET", body: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        ...
        headers = {
            ...
            "User-Agent": "stanzaapi-lei-validator-python/1.0.0"
        }
        if self.api_key:
    ...
    def validate(self, payload: Any) -> Dict[str, Any]:
        ...
        return self._request("/api/v1/validate", method="POST", body=body)
